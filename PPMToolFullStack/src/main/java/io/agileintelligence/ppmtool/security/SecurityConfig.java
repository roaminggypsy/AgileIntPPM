...
// WSCA: provide default security configurations
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .sessionManagement()
                // Server doesn't hold a session, as long as token is valid, server responds. Redux will have state
                ...
                // anything other then that needs authentication
